...
<title>{_esc(set_code)} {_esc(set_name)} — {_esc(as_of)}</title>
...
<footer>
  <p>Every number here describes what has already happened. &ldquo;Still falling&rdquo; is a
  statement about the last fortnight, not the next one &mdash; a card down 70% can go lower, and
  nothing on this page shows a floor. Nothing here knows about bans, reprints or tournament
  results either.</p>
  <p>Generated by <code>radar.setreport</code> · prices from tcgapi.dev</p>
</footer>
</div>
</body></html>"""
