...
def _row_payload(r: dict) -> dict:
    return {
        ...
        "listings_change_7d": r.get("listings_change_7d"),
        "listings_change_30d": r.get("listings_change_30d"),
        "days_of_shelf": r.get("days_of_shelf"),
        "dollars_to_clear": r.get("dollars_to_clear"),
        "dollars_30d": r.get("dollars_30d"),
        "tracked_high": r.get("tracked_high"),
        "tracked_high_date": r.get("tracked_high_date"),
        "tracked_since": r.get("tracked_since"),
        "off_tracked_high_pct": r.get("off_tracked_high_pct"),
