...
<div class="hero">
  ...
  <div class="price"><div class="l">One tier</div><div class="v">$8<small> / month</small></div><div class="f">$88 a year · 7-day trial · no free tier<br>Stripe through Ghost · cancel any time</div></div>
</div>
...
<section id="business">
  ...
  <table class="cmp"><thead><tr><th>Product</th><th>Scope</th><th>Price</th><th>What it lacks against Market Haro</th></tr></thead><tbody>
    <tr class="us"><td>Market Haro</td><td>Gundam Card Game, every English product, daily</td><td><b>$8/mo · $88/yr</b></td><td>Graded and eBay comps (scoped next); a most-played index (scoped next)</td></tr>
  ...
  <div class="grid" style="margin-top:22px">
    ...
    <div class="card"><h4>Break-even</h4><p>Thirty subscribers cover infrastructure. A thousand at $8 is $96,000 a year on a product one person can operate.</p></div>
  </div>
</section>
