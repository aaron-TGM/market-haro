...
<div class="note">This is Market Haro as a subscriber sees it: the members-only report, the email that links to it, and the public track record. $7.99 a month or $75 a year, 7-day trial. Watchlist changes made here stay in this browser.</div>
<script>{JS}</script>
"""
