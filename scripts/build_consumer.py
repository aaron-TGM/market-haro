...
<div class="note">This is Market Haro as a subscriber sees it: the members-only report, the email that links to it, and the public track record. $35 a month or $300 a year, 7-day trial. Watchlist changes made here stay in this browser.</div>
<script>{JS}</script>
"""
