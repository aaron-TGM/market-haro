...
<aside class="rail">
  ...
  <div class="facts">Issue <b>{html.escape(p['obs_date'])}</b><br>Built 2026-09-06<br><b>{len(rows)}</b> pass the screen<br>MH50 <b>{ix.get('value', 0):.1f}</b><br>$8/mo · $88/yr</div>
  <nav>
...
<section id="you">
  ...
  <ul class="todo">
    <li><i></i><span><b>Ghost tier.</b> Settings → Membership: $8 monthly, $88 yearly, 7-day trial on, subscription access paid-members only, free tier hidden in Portal.</span></li>
